        ...
        child: questions == null || records == null
            ...
            : SingleChildScrollView(
                child: Column(children: [
                  ...
                  SizedBox(height: 2.h),
                  Container(child:
                      Consumer<RecordProvider>(builder: (context, recordP, _) {
  ...
  Widget build(BuildContext context) {
    return Padding(
     ...
     ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            ...
                            TextButton(
                                ...
                                onPressed: () async {
                                  if (formkey.currentState!.validate()) {
                                    ...
                                    String res = await Provider.of<LikesProvider>(
                                            context,
                                            listen: false)
                                        .reportRecord(widget.id, titleC.text, token);
        ...
        SizedBox(   width: 80.w, child: Divider(color: Colors.grey.shade300,thickness: 1.5,endIndent: 1,indent: 1,))],
      ),
    );
  }
}
